...
NEWYORK_COORDINATES = {"latitude": 51.5074, "longitude": -0.1278}
STONYBROOK_COORDINATES = {"latitude": 52.4862, "longitude": -1.8904}

# Calculate movement increments
LATITUDE_INCREMENT = (STONYBROOK_COORDINATES['latitude'] - NEWYORK_COORDINATES['latitude']) / 100
LONGITUDE_INCREMENT = (STONYBROOK_COORDINATES['longitude'] - NEWYORK_COORDINATES['longitude']) / 100
...
start_location = NEWYORK_COORDINATES.copy()
...
def simulate_journey(producer, device_id):
    while True:
        ...
        if (vehicle_data['location'][0] >= STONYBROOK_COORDINATES['latitude']
                and vehicle_data['location'][1] <= STONYBROOK_COORDINATES['longitude']):
            print('Vehicle has reached Stony Brook. Simulation ending...')
            break
